...
public class Recive1 {
    private static String QueueName="recive1";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueBind(QueueName,topicName,"student.add");//绑定路由KEY
        channel.queueBind(QueueName,topicName,"student.delete");//绑定路由KEY
        channel.queueBind(QueueName,topicName,"student.update");//绑定路由KEY
        channel.basicQos(1);
        //新方法
